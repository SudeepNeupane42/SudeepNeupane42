...
🎯 Aspiring Data Engineer | BIM Final Year @ Tribhuvan University, Nepal
🔭 Currently building cloud data pipelines with AWS, dbt, and Python
🌱 Learning AWS Glue, Athena, and analytics engineering with dbt
📍 Based in Kathmandu, Nepal — open to data internships
📫 Reach me at: sudeepneupane77@gmail.com
...
|---|---|---|
| [youtube-data-pipeline](https://github.com/SudeepNeupane42/youtube-data-pipeline) | End-to-end cloud ETL pipeline: S3 → Glue → Athena, event-driven with Lambda + Step Functions, SNS alerting, dbt modeling | AWS (S3, Glue, Athena, Lambda, Step Functions, SNS), dbt, Python |
